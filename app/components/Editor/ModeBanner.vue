...
<template>
  <div class="mb-4 flex flex-col items-center justify-between gap-2 rounded -lg border bg-white/5 px-4 py-3 dark:border-white/10">
    <p class="w-full text-xs uppercase tracking-[0.16em]">
